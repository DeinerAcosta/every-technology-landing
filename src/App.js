...
function App() {
  return (
    <div className="min-h-screen bg-white font-montserrat scroll-smooth">
      ...
      {/* Sección Quiénes Somos (incluye Partners internamente) */}
      <About />

      {/* Los 4 Pilares de Servicios */}
      <Services />
      ...
      {/* Cierre de Impacto */}
      <section className="py-32 bg-every-blue text-white text-center border-y border-every-gold/20 px-8">
      ...
      <footer className="bg-every-blue text-every-gray py-20 text-center text-sm border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <img 
            src="/logo texto.png" 
            alt="Every Tech" 
            className="h-12 mx-auto mb-10 brightness-0 invert opacity-90" 
          />
          ...
          <div className="mt-12 text-every-gray/30 text-xs tracking-widest">
